...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <rules>
        <fullName>Internship - End Date Task</fullName>
        <active>false</active>
        <criteriaItems>
            <field>MF_Internship__c.DateEnd__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <criteriaItems>
            <field>MF_Internship__c.State_of_Approval__c</field>
    ...
    <rules>
        <fullName>Internship - State to Active</fullName>
        <active>false</active>
        <criteriaItems>
            <field>MF_Internship__c.DateStart__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <criteriaItems>
            <field>MF_Internship__c.State_of_Approval__c</field>
    ...
    <rules>
        <fullName>Internship - State to Not Active</fullName>
        <active>false</active>
        <criteriaItems>
            <field>MF_Internship__c.DateEnd__c</field>
            <operation>notEqual</operation>
