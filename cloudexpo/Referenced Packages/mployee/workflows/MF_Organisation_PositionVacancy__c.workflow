...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <rules>
        <fullName>Vacancy - State to Active</fullName>
        <active>false</active>
        <criteriaItems>
            <field>MF_Organisation_PositionVacancy__c.DateStart__c</field>
    ...
    <rules>
        <fullName>Vacancy - State to Not Active</fullName>
        <active>false</active>
        <criteriaItems>
            <field>MF_Organisation_PositionVacancy__c.DateEnd__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
